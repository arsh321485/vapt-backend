...
#     """
#     try:
#         logger.info(f"Recaptcha received: {recaptcha_response}")   # 👈 Add here
...
#         # Skip reCAPTCHA verification in dev mode
#         if getattr(settings, 'DEBUG', False):
#             logger.info("DEBUG mode active – skipping reCAPTCHA verification")
#             return True, "reCAPTCHA verification skipped in DEBUG mode"
